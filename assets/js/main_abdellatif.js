$(document).ready(function() {
    ...
    $.getJSON("./data/provinces_centroid.json")
        .done(function(data) {
            // console.log(data);
    ...
    function createPropSymbols(timestamps, data) {
        provinces_centroid = L.geoJSON(data, {
    ...
    function updatePropSymbols(timestamps) {
        provinces_centroid.eachLayer(function(layer) {
    ...
    info.update = function (props) {
        this._div.innerHTML = '<h4>Carte covid, Souss Massa</h3>' + '<br>' + 'Passer la souris sur un symbole';
    };
